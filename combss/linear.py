...
class model:
    ...
    def fit(self, X_train, y_train, X_test, y_test, 
        ...
        result = _optimisation.bss(X_train, y_train, X_test, y_test, t_init=t_init, q = q, scaling=scaling, tau=tau, delta_frac=delta_frac, nlam = nlam, eta=eta, patience=patience, gd_maxiter=gd_maxiter, gd_tol=gd_tol, cg_maxiter = cg_maxiter, cg_tol=cg_tol)
