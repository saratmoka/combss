...
snr_low_list = [0.5, 1, 2, 3, 4, 5, 7, 8]
for snr in snr_low_list:
    df0 = pd.read_csv("./coordinate/COMBSSV0-case-%s-n-%d-p-%s-q-%s-corr-%s-ninit-%s-snr-%s-ndatasets-%s-nlam-%s-eta-%s.csv" %(beta_type, n, p, q, corr, n_tinit, snr,  n_datasets, nlam, eta))
    ...
    df1 = pd.read_csv("./coordinate/COMBSSV4-case-%s-n-%d-p-%s-q-%s-corr-%s-ninit-%s-snr-%s-ndatasets-%s-nlam-%s-eta-%s.csv" %(beta_type, n, p, q, corr, n_tinit, snr,  n_datasets, nlam, eta))
    version1 = {}
...
combssc1, = plt.plot(snr_list, mseV1, label = "Rough Coordinate Approach", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('MSE')
plt.title('COMBSSV0 vs Rough Coordinate Approach, MSE')
...
combssc1, = plt.plot(snr_list, peV1, label = "Rough Coordinate Approach", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('Prediction Error')
plt.title('COMBSSV0 vs Rough Coordinate Approach, Prediction Error')
plt.legend(handles = [combssv0, combssc1])
ax.set_ylim(bottom=0)
plt.show()
...
combssc1, = plt.plot(snr_list, mccV1, label = "Rough Coordinate Approach", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('MCC')
plt.title('COMBSSV0 vs Rough Coordinate Approach, MCC')
plt.legend(handles = [combssv0, combssc1])
ax.set_ylim(bottom=0)
plt.show()
...
combssc1, = plt.plot(snr_list, accuracyV1, label = "Rough Coordinate Approach", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('Accuracy')
plt.title('COMBSSV0 vs Rough Coordinate Approach, Accuracy')
plt.legend(handles = [combssv0, combssc1])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
combssc1, = plt.plot(snr_list, f1V1, label = "Rough Coordinate Approach", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('F1 Score')
plt.title('COMBSSV0 vs Rough Coordinate Approach, F1 Score')
plt.legend(handles = [combssv0, combssc1])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
combssc1, = plt.plot(snr_list, sensitivityV1, label = "Rough Coordinate Approach", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('Sensitivity')
plt.title('COMBSSV0 vs Rough Coordinate Approach, Sensitivity')
plt.legend(handles = [combssv0, combssc1])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
combssc1, = plt.plot(snr_list, specificityV1, label = "Rough Coordinate Approach", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('Specificity')
plt.title('COMBSSV0 vs Rough Coordinate Approach, Specificity')
plt.legend(handles = [combssv0, combssc1])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
combssc1, = plt.plot(snr_list, timeV1, label = "Rough Coordinate Approach", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('Average Time per Dataset (seconds)')
plt.title('COMBSSV0 vs Rough Coordinate Approach, Time')
plt.legend(handles = [combssv0, combssc1])
ax.set_ylim(bottom=0)
plt.show()
# %%
