...
plt.ylabel('MSE')
plt.title('COMBSS Improved Gradient vs COMBSS Normalised Improved Gradient MSE, Beta Case 2 Low Dimension')
...
plt.title('COMBSS Improved Gradient vs COMBSS Normalised Improved Gradient PE, Beta Case 2 Low Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
plt.show()
...
plt.xlabel('Signal to Noise Ratio')
plt.ylabel('MCC')
plt.title('COMBSS Improved Gradient vs COMBSS Normalised Improved Gradient MCC, Beta Case 2 Low Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
plt.show()
...
plt.xlabel('Signal to Noise Ratio')
plt.ylabel('Accuracy')
plt.title('COMBSS Improved Gradient vs COMBSS Normalised Improved Gradient Accuracy, Beta Case 2 Low Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
plt.xlabel('Signal to Noise Ratio')
plt.ylabel('F1 Score')
plt.title('COMBSS Improved Gradient vs COMBSS Normalised Improved Gradient F1 Score, Beta Case 2 Low Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
plt.title('COMBSS Improved Gradient vs COMBSS Normalised Improved Gradient Sensitivity, Beta Case 2 Low Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
plt.title('COMBSS Improved Gradient vs COMBSS Normalised Improved Gradient Specificity, Beta Case 2 Low Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
plt.title('COMBSS Improved Gradient vs COMBSS Normalised Improved Gradient Average Time, Beta Case 2 Low Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
plt.show()
# %%
