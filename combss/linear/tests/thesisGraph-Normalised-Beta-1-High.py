...
plt.ylabel('MSE')
plt.title('COMBSS Original vs COMBSS Normalised MSE, Beta Case 1 High Dimension')
...
plt.title('COMBSS Original vs COMBSS Normalised PE, Beta Case 1 High Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
plt.show()
...
plt.xlabel('Signal to Noise Ratio')
plt.ylabel('MCC')
plt.title('COMBSS Original vs COMBSS Normalised MCC, Beta Case 1 High Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
plt.show()
...
plt.xlabel('Signal to Noise Ratio')
plt.ylabel('F1 Score')
plt.title('COMBSS Original vs COMBSS Normalised F1 Score, Beta Case 1 High Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
plt.title('COMBSS Original vs COMBSS Normalised Sensitivity, Beta Case 1 High Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
plt.title('COMBSS Original vs COMBSS Normalised Specificity, Beta Case 1 High Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
plt.title('COMBSS Original vs COMBSS Normalised Average Time, Beta Case 1 High Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
plt.show()
# %%
