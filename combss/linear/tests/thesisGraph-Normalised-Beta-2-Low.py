...
combssN, = plt.plot(snr_list, mseV1, label = "COMBSS Normalised", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('MSE')
plt.title('COMBSS Original vs COMBSS Normalised MSE, Beta Case 2 Low Dimension')
...
combssN, = plt.plot(snr_list, peV1, label = "COMBSS Normalised", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('Prediction Error')
plt.title('COMBSS Original vs COMBSS Normalised PE, Beta Case 2 Low Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
plt.show()
...
combssN, = plt.plot(snr_list, mccV1, label = "COMBSS Normalised", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('MCC')
plt.title('COMBSS Original vs COMBSS Normalised MCC, Beta Case 2 Low Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
plt.show()
...
combssN, = plt.plot(snr_list, accuracyV1, label = "COMBSS Normalised", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('Accuracy')
plt.title('COMBSS Original vs COMBSS Normalised Accuracy, Beta Case 2 Low Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
combssN, = plt.plot(snr_list, f1V1, label = "COMBSS Normalised", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('F1 Score')
plt.title('COMBSS Original vs COMBSS Normalised F1 Score, Beta Case 2 Low Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
combssN, = plt.plot(snr_list, sensitivityV1, label = "COMBSS Normalised", color = "red", marker='x')
plt.xlabel('Signal to Noise Ratio')
plt.ylabel('Sensitivity')
plt.title('COMBSS Original vs COMBSS Normalised Sensitivity, Beta Case 2 Low Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
combssN, = plt.plot(snr_list, specificityV1, label = "COMBSS Normalised", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('Specificity')
plt.title('COMBSS Original vs COMBSS Normalised Specificity, Beta Case 2 Low Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
ax.set_ylim(top=1)
plt.show()
...
combssN, = plt.plot(snr_list, timeV1, label = "COMBSS Normalised", color = "red", marker='x')

plt.xlabel('Signal to Noise Ratio')
plt.ylabel('Average Time per Dataset (seconds)')
plt.title('COMBSS Original vs COMBSS Normalised Average Time, Beta Case 2 Low Dimension')
plt.legend(handles = [combssO, combssN])
ax.set_ylim(bottom=0)
plt.show()
# %%
