...
def bulk_simV3(n, p, q, beta_type, K0, snr, corr,
	...
	file_path = "./coordinate/COMBSSV0-Coordinate-case-%s-n-%d-p-%s-q-%s-corr-%s-ninit-1-snr-%s-ndatasets-%s-nlam-%s-eta-%s.csv" %(beta_type, n, p, q, corr, snr,  n_datasets, nlam, eta)
