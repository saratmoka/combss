...
def bulk_simV0(n, p, q, beta_type, K0, snr, corr,
	...
	df.to_csv("./sim/bicgstab/COMBSSV0-case-%s-n-%d-p-%s-q-%s-corr-%s-ninit-%s-snr-%s-ndatasets-%s-nlam-%s-eta-%s.csv" %(beta_type, n, p, q, corr, n_tinit, snr,  n_datasets, nlam, eta))
	return
