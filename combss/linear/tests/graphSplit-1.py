...
for snr in snr_high_list:
    ...
    df1 = pd.read_csv("./splitting_test/COMBSSV5-case-%s-n-%d-p-%s-q-%s-corr-%s-ninit-%s-snr-%s-ndatasets-%s-nlam-%s-eta-%s.csv" %(beta_type, n, p, q, corr, n_tinit, snr,  n_datasets, nlam, eta))
    version1 = {}
...
combssc1, = plt.plot(snr_list, mseV1, label = "Splitting Method", color = "red", marker='x')
...
combssc1, = plt.plot(snr_list, peV1, label = "Splitting Method", color = "red", marker='x')
...
combssc1, = plt.plot(snr_list, mccV1, label = "Splitting Method", color = "red", marker='x')
...
combssc1, = plt.plot(snr_list, f1V1, label = "Splitting Method", color = "red", marker='x')
...
combssc1, = plt.plot(snr_list, sensitivityV1, label = "Splitting Method", color = "red", marker='x')
...
combssc1, = plt.plot(snr_list, specificityV1, label = "Splitting Method", color = "red", marker='x')
